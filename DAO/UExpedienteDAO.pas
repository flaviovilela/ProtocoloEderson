...
function TExpedienteDAO.Salvar(var Conexao: TADOConnection; Codigo: integer; N_Expediente, Descricao: AnsiString; Data: TDateTime; Status: integer; var Retorno: AnsiString): integer;
var
...
begin
  try
    ...
    FComandoSQL.ComandoSQL:= 'Insert into Expediente '+
                             ' (Codigo, N_Expediente, Descricao, Status, Data_Lancamento) '+
                             ' values '+
                             ' (:Codigo, :N_Expediente, :Descricao, :Status, :Data_Lancamento) ';
    ...
    FComandoSQL.Valores.Add(Descricao);
...
function TExpedienteDAO.Editar(var Conexao: TADOConnection; Codigo: Integer; N_Expediente, Descricao: AnsiString; Data: TDateTime; Status: integer; var Retorno: AnsiString): integer;
var
  FComandoSQL: TComandoSQLEntidade;
begin
  try
